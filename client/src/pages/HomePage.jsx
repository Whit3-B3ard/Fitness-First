...
function App() {
  ...
  <div classNameName="leading-normal tracking-normal text-indigo-400  bg-cover bg-center bg-fixed  " style={{ backgroundImage: `url(${BackgroundImage})` }}>
      ...
      <div className=" pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center bg-cover " style={{ backgroundImage: `url(${BackgroundImage})` }}>
        ...
        <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden pl-16">
          ...
          <p className="leading-normal text-white text-base md:text-2xl mb-8 text-center md:text-left">
            The First Ever Application Providing Fully Customizable Training Programs for the Disabled.
          </p>
        ...
        <p className="text-center mt-4 text-white font-extrabold text-3xl">Bicep Counter: {counter}</p>
      <img
      ...
      />
        ...
        <div className="mx-auto md:pt-16 pb-16">
          ...
          <div className="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in ">
            <img src={AppStoreImage} className="h-12 pr-12 transform hover:scale-125 duration-300 ease-in-out" />
            <img src={PlayStoreImage} className="h-12 transform hover:scale-125 duration-300 ease-in-out" />
          </div>
        </div>
